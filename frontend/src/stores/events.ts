...
import { fetchEvents, createEvent as apiCreateEvent, deleteEvent as apiDeleteEvent, updateEvent as apiUpdateEvent } from '@/api/eventsApi'
...
export const useEventsStore = defineStore('events', () => {
  ...
  async function refresh() {
    ...
    try {
      ...
      offline.value = false
      const next = applyLocalFilter(list.length ? list : sampleEvents, filter.value)
        .slice()
