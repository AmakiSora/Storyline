...
<template>
  <div class="h-full bg-[#06070b] text-zinc-100">
    <div class="relative h-full">
      <div
        class="absolute inset-0 bg-[radial-gradient(circle_at_30%_10%,rgba(56,189,248,0.18),transparent_40%),radial-gradient(circle_at_80%_20%,rgba(167,139,250,0.15),transparent_45%),radial-gradient(circle_at_60%_90%,rgba(251,146,60,0.12),transparent_40%)]"
      />
      <div class="relative z-10 flex h-full flex-col">
        <header class="px-6 pt-6">
          <div class="flex items-end justify-between gap-6">
            <div class="min-w-0">
              <div class="font-[Fraunces] text-2xl tracking-tight">STORYLINE: INTERACTIVE TIMELINE</div>
              <div class="mt-1 text-sm text-zinc-400">Canvas 渲染 · 缩放/拖拽 · 多时间线模式 · 可编辑事件</div>
            </div>
          </div>
        ...
        <main class="relative flex-1 px-6 pb-6 pt-4">
          <div
            class="relative h-full overflow-hidden rounded-3xl border border-white/10 bg-white/5 shadow-2xl shadow-black/40 backdrop-blur"
          >
